...
/** Entrada pelo Google. Leva para /auth/callback ao voltar. */
export default function BotaoGoogle({ rotulo = "Continuar com o Google" }) {
  ...
  async function entrar() {
    ...
    if (error) {
      setErro("Não deu para abrir o Google: " + error.message);
      setOcupado(false);
    }
    // Deu certo: o navegador sai desta página sozinho
  }
  ...
  return (
    <>
      ...
      <button className="btn btn-bloco btn-google" onClick={entrar} disabled={ocupado}>
